package edu.washington.cs.cse599h.android;
...
import edu.washington.cs.cse599h.android.R;
...
import edu.washington.cs.cse599h.android.update.FirmwareUpdater;
import edu.washington.cs.cse599h.android.update.ReleasesParser;
import edu.washington.cs.cse599h.android.ui.DialogUtils;
import edu.washington.cs.cse599h.android.ui.ExpandableHeightExpandableListView;
...
import edu.washington.cs.cse599h.android.ble.BleDevicesScanner;
import edu.washington.cs.cse599h.android.ble.BleManager;
import edu.washington.cs.cse599h.android.ble.BleUtils;
//import edu.washington.cs.cse599h.android.ble.;
import edu.washington.cs.cse599h.android.ble.UartInterfaceActivity;
...
public class MainActivity extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener, FirmwareUpdater.FirmwareUpdaterListener {
    ...
    private final static int kComponentsNameIds[] = {
            ...
            R.string.scan_connectservice_camera,
    };
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        switch (kComponentsNameIds[which]) {
                            case R.string.scan_connectservice_info: {    // Controller
                            ...
                            case R.string.scan_connectservice_camera: {    // Controller
                                mComponentToStartWhenConnected = LivePreviewActivity.class;
                                break;
                            }
                        }
    ...
    public void onClickDeviceConnect(int scannedDeviceIndex) {
        ...
        if (scannedDeviceIndex < filteredPeripherals.size()) {
            ...
            if (mSelectedDeviceData.type == BluetoothDeviceData.kType_Uart) {      // if is uart, show all the available activities
                ...
                mComponentToStartWhenConnected = InfoActivity.class;
                connect(device);
                Toast.makeText(this, "No UART service found.", Toast.LENGTH_SHORT).show();
            }
        } else {
